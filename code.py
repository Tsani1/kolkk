...
# Tentukan folder nltk_data yang writable
...
# Tambahkan folder ini ke nltk.data.path agar bisa load data dari sini
nltk.data.path.append(nltk_data_dir)

# Download paket ke folder tersebut
